...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   tests_vector3d_scale.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: souahidi <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/02 09:27:21 by souahidi          #+#    #+#             */
/*   Updated: 2025/01/02 09:31:00 by souahidi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	create_and_run_scale_tests1(void)
{
	...
	v1 = (t_vector3d){1, 2, 3};
	result = vector3d_scale(v1, 2.0);
	printf("\n-- vector3d_scale (Set 1) --\n");
...
static void	create_and_run_scale_tests2(void)
{
	...
	v2 = (t_vector3d){1.12345678, 2.23456789, 3.34567890};
	result = vector3d_scale(v2, 1.5);
	printf("\n-- vector3d_scale (Set 2) --\n");
	test_message(fabs(result.x - 1.68518517) < 1e-8 && fabs(result.y
			- 3.351851835) < 1e-8 && fabs(result.z - 5.01851835) < 1e-8,
		"Scale Test 4");
	v2 = (t_vector3d){4.56789012, 5.67890123, 6.78901234};
	result = vector3d_scale(v2, 0.5);
