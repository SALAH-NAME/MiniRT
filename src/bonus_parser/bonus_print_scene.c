...
void	print_object(t_object *obj)
{
	if (obj->type == OBJ_SPHERE)
		printf("sp %.1f,%.1f,%.1f %.1f %d,%d,%d %.1f\n",
			...
			(int)(obj->material.color.r * 255), (int)(obj->material.color.g
				* 255), (int)(obj->material.color.b * 255),
		...
		printf("pl %.1f,%.1f,%.1f %.1f,%.1f,%.1f %d,%d,%d %d,%d,%d %.1f\n",
			...
			(int)(obj->material.color.r * 255), (int)(obj->material.color.g
				* 255), (int)(obj->material.color.b * 255), 0, 0, 0,
			obj->material.specular_coefficient);
...
void	print_scene(t_scene *scene)
{
	...
	printf("\n\n");
	printf("A %.1f %d,%d,%d\n", scene->ambient.ratio,
		(int)(scene->ambient.color.r * 255), (int)(scene->ambient.color.g
			* 255), (int)(scene->ambient.color.b * 255));
	...
	while (light)
	{
		printf("L %.1f,%.1f,%.1f %.1f %d,%d,%d\n", light->position.x,
			light->position.y, light->position.z, light->brightness,
			(int)(light->color.r * 255), (int)(light->color.g * 255),
